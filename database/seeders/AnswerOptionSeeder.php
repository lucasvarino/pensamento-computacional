...
class AnswerOptionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        AnswerOption::factory()->create([
            'title' => 'Está conversando com amigos em um ponto de encontro.',
            'group_id' => 4,
            'question_id' => 1
        ]);

        AnswerOption::factory()->create([
            'title' => 'Somente derrotar um vilão.',
            'group_id' => 1,
            'question_id' => 2
        ]);

        AnswerOption::factory()->create([
            'title' => 'Derrotar o vilão e gabar-se sobre isto com os seus amigos.',
            'group_id' => 4,
            'question_id' => 2
        ]);
        ...
        AnswerOption::factory()->create([
            'title' => 'Administrar minha própria taverna.',
            'group_id' => 4,
            'question_id' => 6
        ]);

        AnswerOption::factory()->create([
            'title' => 'Fazer meus próprios mapas do mundo e vendê-los.',
            'group_id' => 2,
            'question_id' => 6
        ]);
        ...
        AnswerOption::factory()->create([
            'title' => 'Convoco um grande grupo de jogadores para me ajudar a derrotá-lo.',
            'group_id' => 4,
            'question_id' => 9
        ]);

        AnswerOption::factory()->create([
            'title' => 'Testo diversas armas e mágicas para encontrar suas fraquezas.',
            'group_id' => 2,
            'question_id' => 9
        ]);
        ...
        AnswerOption::factory()->create([
            'title' => 'Ganhar um duelo contra outro jogador.',
            'group_id' => 3,
            'question_id' => 13
        ]);
        ...
        AnswerOption::factory()->create([
            'title' => 'Vai até uma área com a qual seu oponente não está familiarizado e se prepara la.',
            'group_id' => 2,
            'question_id' => 25
        ]);
