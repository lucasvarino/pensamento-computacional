            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-4">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="ml-2 text-xl font-semibold text-gray-900 dark:text-gray-200">Ajuda e Suporte</h2>
                    </div>
                    <p class="text-gray-600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-4">
                ...
                <div class="space-y-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="ml-2 text-xl font-semibold text-gray-900 dark:text-gray-200">Seu Perfil</h2>
                    </div>
                    <p class="text-gray-600">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="ml-2 text-xl font-semibold text-gray-900 dark:text-gray-200">Notificações</h2>
                    </div>
                    <p class="text-gray-600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-4">
                ...
                <div class="space-y-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="ml-2 text-xl font-semibold text-gray-900 dark:text-gray-200">Visão geral</h2>
                    </div>
                    <p class="text-gray-600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-4">
                ...
                <div class="space-y-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="ml-2 text-xl font-semibold text-gray-900 dark:text-gray-200">Listagem de Turmas</h2>
                    </div>
                    <p class="text-gray-600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-4">
                ...
                <div class="space-y-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="ml-2 text-xl font-semibold text-gray-900 dark:text-gray-200">Criando uma Turma</h2>
                    </div>
                    <p class="text-gray-600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-4">
                ...
                <div class="space-y-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="ml-2 text-xl font-semibold text-gray-900 dark:text-gray-200">Opções da Turma</h2>
                    </div>
                    <p class="text-gray-600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-4">
                ...
                <div class="space-y-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="ml-2 text-xl font-semibold text-gray-900 dark:text-gray-200">Resultados Gerais da Turma</h2>
                    </div>
                    <p class="text-gray-600">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="ml-2 text-xl font-semibold text-gray-900 dark:text-gray-200">Gráfico dos resultados gerais</h2>
                    </div>
                    <p class="text-gray-600">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="ml-2 text-xl font-semibold text-gray-900 dark:text-gray-200">Número de respostas</h2>
                    </div>
                    <p class="text-gray-600">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="ml-2 text-xl font-semibold text-gray-900 dark:text-gray-200">Tabela com os alunos que responderam</h2>
                    </div>
                    <p class="text-gray-600">
