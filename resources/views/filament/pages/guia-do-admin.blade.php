            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-4">
                ...
                <div class="space-y-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="ml-2 text-xl font-semibold text-gray-900">Visão geral (Para Administradores!)</h2>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-4">
                ...
                <div class="space-y-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="ml-2 text-xl font-semibold text-gray-900">Listagem de Usuários</h2>
                    </div>
                    <p class="text-gray-600">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="ml-2 text-xl font-semibold text-gray-900">Opções do Usuário</h2>
                    </div>
                    <p class="text-gray-600">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="ml-2 text-xl font-semibold text-gray-900">Aprovar Usuário</h2>
                    </div>
                    <p class="text-gray-600">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="ml-2 text-xl font-semibold text-gray-900">Alterar Admin</h2>
                    </div>
                    <p class="text-gray-600">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <h2 class="ml-2 text-xl font-semibold text-gray-900">Deletar Usuário</h2>
                    </div>
                    <p class="text-gray-600">
