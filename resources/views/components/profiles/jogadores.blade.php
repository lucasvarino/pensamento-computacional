...
<div class="relative bg-jogador rounded-2xl shadow-lg overflow-hidden mb-6
  ...
  <svg
      ...
      <div class="hidden sm:block absolute bottom-0">
        <img src="{{ asset('img/manete.png') }}" alt="Manete" class="w-16 h-16" />
      </div>
    </div>
    ...
    <p class="text-sm font-semibold text-jogador-txt w-full sm:px-28">
      {{ $result['description'] }}
    </p>
  </div>
